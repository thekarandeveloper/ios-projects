...
let soemPlace = GPS(lalitude: 51.514004, longitude: 0.125226)
print(soemPlace.lalitude)
print(soemPlace.longitude)
...
let favoriteBook = book(title: "harry", author: "charles", pages: 4141, prices: 41.45)
...
struct hight {
    ...
    init(heightInInches: Double) {
        ...
        self.heightInCentimeter = heightInInches * 2.64
    }
    
    init (heightImCentimeter : Double) {
        self.heightInCentimeter = heightImCentimeter
        self.heightInInches = heightImCentimeter / 2.54
    }
}
...
var someonesHight = hight(heightInInches: 65)
print(someonesHight.heightInCentimeter)
...
var myHight = hight(heightImCentimeter: 180)
print(myHight.heightInInches)
