...
struct RunningWorkout {
    ...
    var averageMileTimez: Double {
        return distance / (1600 * time)
    }
    
}
let workout = RunningWorkout(distance: 400, time: 410, elevation: 41)
print(workout.averageMileTimez)
...
var steps = Steps(steps: 9_000, goal: 4)
steps.takeStep()
