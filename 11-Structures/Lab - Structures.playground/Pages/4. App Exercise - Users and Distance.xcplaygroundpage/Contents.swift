...
var yourname = user(username: "aman", age: 21, height: 6.1, weight: 65, activityLevel: 52)
print("hi myself \(yourname.username) age of \(yourname.age), height of \(yourname.height) and weight of \(yourname.weight)")
...
struct distance {
    ...
    init(meters: Double) {
        self.meters = meters
        self.feet = meters * 3.232342
    }
    
    init(feet : Double){
        self.feet = feet
        self.meters = feet * 3.232342
    }
}
...
let anotherDistance = distance(feet: 14)
